...
horarioTextual a b c = listaExt a ++ " horas," ++ " " ++ listaExt b ++ " e " ++ listaExt c ++ " segundos"

listaExt :: Int -> String
listaExt n = ["Zero", "Um", "Dois", "Três", "Quatro", "Cinco", "Seis", "Sete", "Oito", "Nove", "Dez",
              ...
              "Cinquenta e oito", "Cinquenta e nove", "Sessenta"] !! n
